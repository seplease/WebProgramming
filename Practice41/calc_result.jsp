			...
			<table>
				...
				<tr>
					...
					<input type="text" name="op1" style="text-align: center" size="5"
						value=<%=request.getParameter("op1")%> readonly><br>
					<br> <%=request.getParameter("operator")%><br>
					<br> <input type="text" name="op2" style="text-align: center"
						size="5" value=<%=request.getParameter("op2")%> readonly><br>
					<br> =<br>
					<br> <input type="text" name="result" size="7"
						value=${calc.calc(calc.op1, calc.op2, calc.operator)} disabled></td>
				</tr>
