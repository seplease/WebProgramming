...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*" import="pr35.*"%>
<!DOCTYPE html>
<jsp:useBean id="lecture" class="pr35.LectureBean"/>
<jsp:setProperty name="lecture" property="*"/>
<jsp:useBean id="lm" class="pr35.LectureManager" scope="application"/>
<%
...
<body>
<div align="center">
<form name="form1" method="POST" action="practice35.jsp">
과목타입:
<select name="type">
