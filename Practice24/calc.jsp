            ...
            <table>
                ...
                <tr>
                    ...
                    <td width="155px" style="text-align:center">
                        <br><br><input type="text" name="num1" style="text-align:center" size="5" value="0"><br><br>
                        <select name="op">
                        	<option value="+">+</option>
                        	<option value="-">-</option>
                        	<option value="*">*</option>
                        ...
                        <input type="text" name="num2" style="text-align:center" size="5" value="0"><br><br>
                        <input type="submit" name="num2" value="="><br><br>
                        <input type="text" name="result" size="7" disabled>
                    </td>
                </tr>
